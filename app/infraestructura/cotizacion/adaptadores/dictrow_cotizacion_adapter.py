...
class DictRowCotizacionAdapter:
    ...
    def to_cotizacion(self) -> Cotizacion:
        ...
        return Cotizacion(
            ...
            asistencia_afecta=self.row['asistencia_afecta'],
            asistencia_excenta=self.row['asistencia_excenta'],
            prima_afecta=self.row['prima_afecta'],
            prima_excenta=self.row['prima_excenta'],
            prima_neta=self.row['prima_neta'],
            prima_iva=self.row['prima_iva'],
            prima_bruta=self.row['prima_bruta'],
