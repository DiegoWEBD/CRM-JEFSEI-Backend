...
from app.presentacion.api.proceso_comercial.dependencias.deps import get_actualizar_fecha_estimada_cierre_use_case
...
@pytest.fixture
def client_propios(usuario_propios, use_case_actualizar_mock):
...
@pytest.fixture
def client_solo_global(usuario_solo_global, use_case_actualizar_mock):
    def override_get_current_user():
